...
(defconst cygwin-mount-program "mount")
(defconst cygwin-mount-uname-program "uname")
...
<= 1.1.8 and >= 1.3.1."
  (if (string-match "^1\\.3" (cygwin-mount-get-cygwin-version))
